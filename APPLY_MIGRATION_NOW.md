# ⚠️ ТРЕБУЕТСЯ ДЕЙСТВИЕ: Примените миграцию PostgreSQL

## Проблема
```
Error: Could not find the table 'public.bookings' in the schema cache
```

Таблицы PostgreSQL еще не созданы. Необходимо выполнить SQL миграцию.

## ✅ Решение (5 минут)

### Шаг 1: Откройте Supabase Dashboard
🔗 https://supabase.com/dashboard/project/drvrlhbqnmtfqfokwevd
...
Должны увидеть сообщение: **Success. No rows returned**
...
Должны увидеть 3 зала.

## После применения миграции

Приложение автоматически заработает! Обновите страницу браузера.
